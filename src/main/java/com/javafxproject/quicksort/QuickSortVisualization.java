package com.javafxproject.quicksort;
...
public class QuickSortVisualization extends Application {
    ...
    private final int[] c2w_hue = new int[c2w_ARRAY_SIZE];  // The array that will be sorted.
    private final Color[] c2w_palette = new Color[c2w_ARRAY_SIZE]; // Colors in spectral order.
    ...
    /**
     * When the user aborts the recursion before it finishes, an exception to
     * this type is thrown to end the recursion cleanly.
     */
    private static class ThreadTerminationException extends RuntimeException {
    }
    ...
    private void c2w_drawSorted() {
        ...
        double barWidth = (c2w_canvas.getWidth() - 6) / c2w_palette.length;
     ...
     *                        c2w_colorNumber is a c2w_index into the c2w_palette array.
     */
     ...
     * terminating, so that whether the c2w_quickSort is aborted,
    ...
    private class Runner extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                Platform.runLater(QuickSortVisualization.this::c2w_drawSorted);
            } finally {
